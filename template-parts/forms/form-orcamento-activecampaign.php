...
<form method="POST" action="https://zoeweb.activehosted.com/proc.php" id="_form_1_" class="_form _form_1 _inline-form  _dark" novalidate>
  ...
  <div class="_form-content">
    <div class="_form_element _x34921875 _full_width " >
    ...
    <div class="_form_element _x71437658 _full_width " >
      <label class="_form-label">
        E-mail*
      </label>
      <div class="_field-wrapper">
    ...
    <div class="_form_element _x81063115 _full_width " >
      <label class="_form-label">
        Telefone*
      </label>
      <div class="_field-wrapper">
    ...
    <div class="_form_element _field4 _full_width " >
      <label class="_form-label">
        Possui equipamentos e internet no local?
      </label>
      <div class="_field-wrapper">
        <select name="field[4]" >
    ...
    <div class="_form_element _field6 _full_width " >
      <label class="_form-label">
        Previsão da quantidade de usuários simultâneos
      </label>
      <div class="_field-wrapper">
        <select name="field[6]" >
          <option value="0 - 150" >
